...
public class Robot {
    static String[][] robotMap;
    static String penDirection = null, robotFace = null;
    ...
    static String changeRobotFaceLeft(String robotFace) {
    ...
    static String changeRobotFaceRight(String robotFace) {
        if (robotFace.equals("north"))
            robotFace = "east";
        else if (robotFace.equals("south"))
            robotFace = "west";
    ...
    static String[][] trackRobot(int oldX, int oldY, int newX, int newY, String penDirection, String[][] robotMap) {
        int i, j;
    ...
    public static void inputCommand(){
        ...
        while (flag) {
            ...
            try {
                if ((commandArray[0].equalsIgnoreCase("I"))) {
                ...
                } else if ((commandArray[0].equalsIgnoreCase("M"))) {
                    int robotPosition = Integer.parseInt(commandArray[1]);
                    move(null, commandArray, robotPosition, command, command, robotMap);
                } 
            
                else if ((commandArray[0].equalsIgnoreCase("R"))) 
                	robotFace = changeRobotFaceRight(robotFace);
                else if ((commandArray[0].equalsIgnoreCase("L"))) 
                	robotFace = changeRobotFaceLeft(robotFace);
                else if ((commandArray[0].equalsIgnoreCase("U"))) 
                	penDirection = "up";
                else if ((commandArray[0].equalsIgnoreCase("D"))) 
                	penDirection = "down";
                else if ((commandArray[0].equalsIgnoreCase("C"))) {
                ...
                } else if ((commandArray[0].equalsIgnoreCase("Q"))) {
                	System.out.println("End of Program");
                	flag = false;
                } else if ((commandArray[0].equalsIgnoreCase("P"))) 
                	printArray(nMatrix);
                else 

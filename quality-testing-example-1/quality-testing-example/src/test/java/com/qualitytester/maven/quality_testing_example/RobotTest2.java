...
public class RobotTest2 {
    ...
    public void testMoveInAllDirections() {
        ...
        commandArray = new String[]{"m", "3"};
        Robot.move(robotPosition, commandArray, nMatrix, "east", "up", robotMap);
        commandArray = new String[]{"m", "1"};
        Robot.move(robotPosition, commandArray, nMatrix, "south", "up", robotMap);
        commandArray = new String[]{"m", "3"};
        Robot.move(robotPosition, commandArray, nMatrix, "west", "up", robotMap);
        int[] expectedPosition = new int[]{1, 0}; 
        assertArrayEquals(expectedPosition, robotPosition);
    }
    @Test
